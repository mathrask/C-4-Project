---
title: "National Emissions Inventory PM2.5" 
author: "Suresh Mathrakott"
...
```r
packages <- c("data.table", "ggplot2", "plyr")
...
```
## [1] "C:/Users/username/Coursera/C-4-Project"
```

Down load the files [ this is already done. don't repeat]
...
```r
knit("nei_pm25.Rmd", output="codebook.md", encoding="ISO8859-1", quiet=TRUE)
```
